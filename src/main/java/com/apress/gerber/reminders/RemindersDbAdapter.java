...
public class RemindersDbAdapter {
    ...
    private static final String TABLE_NAME="lbl_remdrs";
...
//open
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper{
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion){
            Log.w(TAG,"Upgreading databse from version"+oldVersion+"to"+newVersion+",which will destroy all old data");
            db.execSQL("DROP TABLSE IF EXISTS "+TABLE_NAME);
            onCreate(db);
        }
    }
}
